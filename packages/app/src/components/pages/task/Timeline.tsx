...
export function Timeline(props: Props) {
  ...
  return (
    ...
    <div class="flex flex-col h-full bg-muted/30 border-t select-none">
      ...
      {/* Ruler */}
      <div class="h-5 relative border-b bg-muted/20 text-[10px] text-muted-foreground flex-shrink-0 overflow-hidden">
        <div style={{ width: `${totalPx()}px`, "min-width": "100%" }} class="relative h-full">
          <div
      ...
      <div class="flex-1 flex flex-col overflow-auto">
        ...
        <div class="flex h-8 border-b">
          <div class="w-10 flex-shrink-0 border-r text-[10px] text-muted-foreground flex items-center justify-center bg-muted/10">
            🎤
          </div>
